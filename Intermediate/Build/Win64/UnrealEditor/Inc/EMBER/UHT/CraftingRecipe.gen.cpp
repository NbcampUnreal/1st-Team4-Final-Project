...
// Begin Class UCraftingRecipe Function bCanCraft
struct Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics
{
	struct CraftingRecipe_eventbCanCraft_Parms
	{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		...
		{ "Comment", "// \xec\xa0\x9c\xec\x9e\x91\xec\x9d\xb4 \xea\xb0\x80\xeb\x8a\xa5\xed\x95\x9c\xec\xa7\x80 \xec\x97\xac\xeb\xb6\x80\n" },
#endif
		{ "ModuleRelativePath", "Crafting/CraftingRecipe.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xec\xa0\x9c\xec\x9e\x91\xec\x9d\xb4 \xea\xb0\x80\xeb\x8a\xa5\xed\x95\x9c\xec\xa7\x80 \xec\x97\xac\xeb\xb6\x80" },
#endif
	};
...
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_AvailableIngredients_ValueProp = { "AvailableIngredients", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 1, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_AvailableIngredients_Key_KeyProp = { "AvailableIngredients_Key", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FMapPropertyParams Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_AvailableIngredients = { "AvailableIngredients", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Map, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CraftingRecipe_eventbCanCraft_Parms, AvailableIngredients), EMapPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AvailableIngredients_MetaData), NewProp_AvailableIngredients_MetaData) };
const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_PlayerCraftingLevel = { "PlayerCraftingLevel", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(CraftingRecipe_eventbCanCraft_Parms, PlayerCraftingLevel), METADATA_PARAMS(0, nullptr) };
void Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((CraftingRecipe_eventbCanCraft_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(CraftingRecipe_eventbCanCraft_Parms), &Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_AvailableIngredients_ValueProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_AvailableIngredients_Key_KeyProp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_AvailableIngredients,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_PlayerCraftingLevel,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UCraftingRecipe, nullptr, "bCanCraft", nullptr, nullptr, Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::PropPointers), sizeof(Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::CraftingRecipe_eventbCanCraft_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54420401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::Function_MetaDataParams), Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::CraftingRecipe_eventbCanCraft_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UCraftingRecipe_bCanCraft()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UCraftingRecipe_bCanCraft_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UCraftingRecipe::execbCanCraft)
{
	P_GET_TMAP_REF(FString,int32,Z_Param_Out_AvailableIngredients);
	P_GET_PROPERTY(FIntProperty,Z_Param_PlayerCraftingLevel);
	P_FINISH;
	P_NATIVE_BEGIN;
	*(bool*)Z_Param__Result=P_THIS->bCanCraft(Z_Param_Out_AvailableIngredients,Z_Param_PlayerCraftingLevel);
	P_NATIVE_END;
}
// End Class UCraftingRecipe Function bCanCraft
...
void UCraftingRecipe::StaticRegisterNativesUCraftingRecipe()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		{ "bCanCraft", &UCraftingRecipe::execbCanCraft },
	};
...
struct Z_Construct_UClass_UCraftingRecipe_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_ItemName_MetaData[] = {
		{ "Category", "Crafting" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// \xec\xa0\x9c\xec\x9e\x91\xed\x95\xa0 \xec\x95\x84\xec\x9d\xb4\xed\x85\x9c \xec\x9d\xb4\xeb\xa6\x84\n" },
#endif
		{ "ModuleRelativePath", "Crafting/CraftingRecipe.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xec\xa0\x9c\xec\x9e\x91\xed\x95\xa0 \xec\x95\x84\xec\x9d\xb4\xed\x85\x9c \xec\x9d\xb4\xeb\xa6\x84" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Ingredients_MetaData[] = {
		{ "Category", "Crafting" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// \xed\x95\x84\xec\x9a\x94\xed\x95\x9c \xec\x9e\xac\xeb\xa3\x8c(\xec\x9e\xac\xeb\xa3\x8c \xec\x9d\xb4\xeb\xa6\x84, \xec\x88\x98\xeb\x9f\x89)\n" },
#endif
		{ "ModuleRelativePath", "Crafting/CraftingRecipe.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xed\x95\x84\xec\x9a\x94\xed\x95\x9c \xec\x9e\xac\xeb\xa3\x8c(\xec\x9e\xac\xeb\xa3\x8c \xec\x9d\xb4\xeb\xa6\x84, \xec\x88\x98\xeb\x9f\x89)" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_RequiredCraftingLevel_MetaData[] = {
		{ "Category", "Crafting" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// \xec\xb5\x9c\xec\x86\x8c \xec\xa0\x9c\xec\x9e\x91 \xeb\xa0\x88\xeb\xb2\xa8\n" },
#endif
		{ "ModuleRelativePath", "Crafting/CraftingRecipe.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xec\xb5\x9c\xec\x86\x8c \xec\xa0\x9c\xec\x9e\x91 \xeb\xa0\x88\xeb\xb2\xa8" },
#endif
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_CraftingTime_MetaData[] = {
		{ "Category", "Crafting" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// \xec\xa0\x9c\xec\x9e\x91\xec\x97\x90 \xea\xb1\xb8\xeb\xa6\xac\xeb\x8a\x94 \xec\x8b\x9c\xea\xb0\x84\n" },
#endif
		{ "ModuleRelativePath", "Crafting/CraftingRecipe.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "\xec\xa0\x9c\xec\x9e\x91\xec\x97\x90 \xea\xb1\xb8\xeb\xa6\xac\xeb\x8a\x94 \xec\x8b\x9c\xea\xb0\x84" },
#endif
	};
#endif // WITH_METADATA
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UCraftingRecipe_bCanCraft, "bCanCraft" }, // 3815810152
	};
...
struct Z_CompiledInDeferFile_FID_Git_1st_Team4_Final_Project_Source_EMBER_Crafting_CraftingRecipe_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UCraftingRecipe, UCraftingRecipe::StaticClass, TEXT("UCraftingRecipe"), &Z_Registration_Info_UClass_UCraftingRecipe, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCraftingRecipe), 417615338U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Git_1st_Team4_Final_Project_Source_EMBER_Crafting_CraftingRecipe_h_993996671(TEXT("/Script/EMBER"),
