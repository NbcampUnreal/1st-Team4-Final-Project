...
struct Z_Construct_UClass_UEmberUIData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_InventoryValidWidgetClass_MetaData[] = {
		{ "Category", "EmberUIData" },
		{ "ModuleRelativePath", "UI/Data/EmberUIData.h" },
	};
	...
	static const UECodeGen_Private::FClassPropertyParams NewProp_InventoryValidWidgetClass;
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UEmberUIData_Statics::NewProp_InventoryValidWidgetClass = { "InventoryValidWidgetClass", nullptr, (EPropertyFlags)0x0014000000010001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UEmberUIData, InventoryValidWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UInventoryValidWidget_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InventoryValidWidgetClass_MetaData), NewProp_InventoryValidWidgetClass_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UEmberUIData_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UEmberUIData_Statics::NewProp_InventoryValidWidgetClass,
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_code_NBCamp_1st_Team4_Final_Project_Source_EMBER_UI_Data_EmberUIData_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEmberUIData, UEmberUIData::StaticClass, TEXT("UEmberUIData"), &Z_Registration_Info_UClass_UEmberUIData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEmberUIData), 1368459257U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_code_NBCamp_1st_Team4_Final_Project_Source_EMBER_UI_Data_EmberUIData_h_240478875(TEXT("/Script/EMBER"),
	Z_CompiledInDeferFile_FID_code_NBCamp_1st_Team4_Final_Project_Source_EMBER_UI_Data_EmberUIData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_code_NBCamp_1st_Team4_Final_Project_Source_EMBER_UI_Data_EmberUIData_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
