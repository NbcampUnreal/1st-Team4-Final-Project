...
#include "EmberAbilityTagRelationshipMapping.generated.h"

USTRUCT()
struct FEmberAbilityTagRelationship
{
	GENERATED_BODY()
...
UCLASS()
class EMBER_API UEmberAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FEmberAbilityTagRelationship> AbilityTagRelationships;
